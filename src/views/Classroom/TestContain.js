...
const useStyles = makeStyles({
 ...
 class Views extends Component {
   ...
   componentDidMount = async ()=>{
      await axios.get("http://localhost/back-end/classes/view_classes.php")
    ...
    render(){
       ...
       return(
           <div>
            ...
            <thead>
                <tr style={{}}>
                      <td style={{fontWeight:"bold",textAlign:"center",padding:"10px 0px 10px 0px"}}>Lste salle de classe </td>
                </tr>
                 
                <tr style={{backgroundColor:"rgb(17, 141, 65)"}}>
                <th style={{ color:'white', fontWeight:"bold", textAlign:"center", padding:"10px"}} >DATE CREATION </th> 
                <th style={{ color:'white', fontWeight:"bold", textAlign:"center", padding:"10px"}} >MAX ELEVES </th> 
                <th style={{ color:'white', fontWeight:"bold", textAlign:"center", padding:"10px"}}>NOM CLASSE </th> 
                <th style={{ color:'white', fontWeight:"bold", textAlign:"center", padding:"10px"}}> TOTAL ELEVES </th> 
                <th style={{ color:'white', fontWeight:"bold", textAlign:"center", padding:"10px"}}> ELEVES </th> 
                <th > </th> 
                </tr> 
