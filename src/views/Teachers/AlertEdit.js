...
export default function AlertDialog({ mhs  ,setAnchorEl,refresh, componentDidMount }) {
  ...
  const handleEditClick = () => {
    try{
      axios.post('http://localhost/back-end/Teachers/edit_teachears.php?id='+mhs.idensei , data);
      console.log(data);
      setOpen(false);
        ...
        <DialogContent>
          ...
          <div className="signup">
                     <div className="content" >
                           <div>
                                <form  >
                                  <h3 style={{color:"rgb(17, 141, 65)",textAlign:"center"}}> MOFIFIER L'ENSEIGNANT {mhs.usernames} { mhs.names} </h3>
