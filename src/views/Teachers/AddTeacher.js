...
class AddTeacher extends Component {
  ...
  render(){
     return(
         ...
         <Typography style={{fontFamily: "Times New Roman, Times, serif",color:'rgb(17, 141, 65)',fontWeight:'bold',fontSize:'20px'}}>AJOUTER UN ENSEIGNANT </Typography> <br/>
         ...
         <div style={{  width: '100%',borderRadius:'20px',backgroundColor:'white'}}>
            <div style={{backgroundColor:'rgb(17, 141, 65)', borderRadius:'10px 10px 0px 0px',}}>
             <Typography style={{fontFamily: "Times New Roman, Times, serif",color:'white',padding:'7px 0px 7px 30px',fontWeight:'bold'}}>Informations sur l'enseignant</Typography>
           </div>
        </div>
   ...
   <div style={{display:'flex',justifyContent:'space-evenly',width:'auto',backgroundColor:'white'}}>
          ...
          <div style={{width:'100px',textAlign:"center",padding:"30px 0px 0px 0px"}}>
                 <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold'}}>&nbsp;&nbsp;&nbsp; Photos*</Typography>
                  <div>
            ...
            <div style={{width:'450px',padding:'30px 0px 7px 0px',lineHeight:'80px'}}>
                 <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold',}}>  Nom </Typography>
                <TextField
                ...
                <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold',}}>  Prenom </Typography>
                <TextField
                  style={{  width: '100%',borderRadius:'20px',backgroundColor:'white'}}  variant="filled" 
                   type="text" onChange={this.onChangeNames} value={this.state.names} name="names"  placeholder='names'/>
                
                <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold',}}>  Email </Typography>
                <TextField
                  style={{  width: '100%',borderRadius:'20px',backgroundColor:'white'}}  variant="filled"
                      type="text" onChange={this.onChangeEmail} value={this.state.email} name="email"  placeholder='email...'/>

                <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold',}}>  Mot de pass </Typography>
                <TextField
                  style={{  width: '100%',borderRadius:'20px',backgroundColor:'white'}}  variant="filled"
              ...
              <div style={{width:'450px',padding:'30px 0px 7px 0px',lineHeight:'80px'}}>    
                ...
                <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold'}}> Telephone </Typography>   
                <TextField
                  style={{  width: '100%',borderRadius:'20px',backgroundColor:'white'}}  variant="filled"
                   type="text" onChange={this.onChangePhone} value={this.state.phone} name="phone"  placeholder='phone...'/>
               
                
               <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold'}}>Salle de classe</Typography>
                <TextField
                  style={{  width: '100%',borderRadius:'20px',backgroundColor:'white'}}  variant="filled" 
                   type="text" onChange={this.onChangeClassroom} value={this.state.classroom} name="classroom" placeholder='classroom...'/>


                  <Typography style={{fontFamily: "Times New Roman, Times, serif",fontWeight:'bold'}}> Verifier </Typography>   

                      <SelectClass/>


               <Button
                  style={{fontFamily: "Times New Roman, Times, serif", backgroundColor:'rgb(17, 141, 65)',width:'150px',color:'white'}}
                  type='submit' 
